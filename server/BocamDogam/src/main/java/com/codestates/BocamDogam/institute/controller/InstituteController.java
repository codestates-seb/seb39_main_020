...
public class InstituteController {
    ...
    // 교육기관 생성 요청
    @PostMapping
    public ResponseEntity postInstitute(@Valid @RequestBody
                                            InstituteDto.Post requestBody) {
    ...
    public ResponseEntity getInstitute(@PathVariable("institute-id") @Positive
                                           Long instituteId) {
