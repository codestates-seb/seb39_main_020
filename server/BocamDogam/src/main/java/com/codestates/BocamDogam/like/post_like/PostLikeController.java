...
public class PostLikeController {
    ...
    public PostLikeController(PostLikeService postLikeService, MemberService memberService, PostService postService, PostLikeRepository postLikeRepository) {
    ...
    public ResponseEntity postlike(@RequestHeader("Authorization") String token,
        ...
        // 콘솔 출력 확인용
        System.out.println("::::::::::::::::::::::::::::::::::");
        System.out.println(postLike.getPostLikeId());
        System.out.println(postLike.getPost().getPostId());
        System.out.println(postLike.getMember().getMemberId());
        System.out.println("::::::::::::::::::::::::::::::::::");
